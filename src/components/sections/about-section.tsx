      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mb-6">
              <h4 className="text-lg font-medium mb-3 text-primary-foreground/90">Core Proficiencies:</h4>
            ...
            <Button asChild size="lg" variant="outline" className="shadow-md hover:shadow-lg transition-shadow text-primary-foreground border-primary-foreground/50 hover:bg-accent hover:text-accent-foreground hover:border-accent">
              <Link href="/skills">
