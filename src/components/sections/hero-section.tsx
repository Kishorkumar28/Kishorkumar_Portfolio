  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-secondary/30 relative overflow-hidden px-4 py-16 pt-32 md:pt-16">
      ...
      <div className="container mx-auto text-center relative z-10">
        <div className="max-w-3xl mx-auto animate-fade-in-up" style={{ animationFillMode: 'forwards' }}>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-6">
            <span className="block">Hello, I&apos;m</span>
            <span className="block text-primary">{siteConfig.author}</span>
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground mb-8" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }} >
            A Full-Stack Developer crafting seamless digital experiences with the MERN stack and modern web technologies.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce hidden md:block" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
