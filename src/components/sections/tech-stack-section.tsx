...
const ReactLogo: FC = () => (
  <svg viewBox="-10.5 -9.45 21 18.9" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-sky-500 group-hover:text-sky-400 transition-colors">
...
const JavaScriptLogo: FC = () => (
  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 group-hover:opacity-90 transition-opacity">
...
const HtmlLogo: FC = () => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 group-hover:opacity-90 transition-opacity">
